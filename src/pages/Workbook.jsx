		...
		<div className="app_workbook">
			...
			<div className="app_workbook-2cols">
				<div className="app_workbook-2cols-l padding">
					...
					<p className="p-text">
						A brand’s purpose is the fundamental reason it exists beyond making
						money. It reflects the positive impact the brand aims to have on the
						world. <span className="show-sm">(Look below for examples)</span>
					</p>
					<div>
						<textarea
			...
			<div className="app_workbook-2cols">
				<div className="app_workbook-2cols-l padding whitebg">
					...
					<p className="p-text">
						...
						objectives and approach to reach those objectives. It outlines what
						the company aims to achieve in the short to medium term. world.{' '}
			...
			<div className="app_workbook-2cols">
				<div className="app_workbook-2cols-l padding">
					...
					<p className="p-text">
						...
						company’s behaviour and decision-making. They shape the company’s
						culture and define how it interacts with customers, employees, and
			...
			<div className="padding section whitebg">
				...
				<div className="app_workbook-grid">
					...
					<div>
						<p className="bold-text">What are the strengths of your brand?</p>
						<div>
							<textarea
								className="primarybg"
								placeholder="Use this text box"
			...
			<div className="padding section primarybg">
				...
				<div className="app_workbook-grid">
					<div>
						<p className="bold-text">
							Who are your primary target audience and what do they look like?
						</p>
						<div>
							<textarea
								className="whitebg"
			...
			<div className="padding section whitebg">
				...
				<div className="app_workbook-grid">
					...
					<div>
						<p className="bold-text">
							What are 3 words you want your audience to think of when they see
							your logo?
						</p>
						<div>
							<textarea
			...
			<div className="padding section whitebg">
				<div className="app_workbook-grid">
					<div className="sub-grid">
						...
						<div>
							<p className="bold-text">Do you have any colour preferences?</p>
							<div>
								<textarea
									className="primarybg"
									placeholder="Use this text box"
						...
						<div>
							<p className="bold-text">What are your typography preference</p>
							<div>
								<textarea
									className="primarybg"
									placeholder="Use this text box"
					...
					<div className="sub-grid">
						<p className="bold-text">What type of logo are you looking for?</p>
						<div>
			...
			<div className="padding section primarybg">
				...
				<div className="app_workbook-grid">
					<div className="sub-grid">
						...
						<div className="row-1">
							<p className="bold-text">
								When looking at other brand’s logos, which do you like and why?
							</p>
							<div>
								<textarea
									className="whitebg"
